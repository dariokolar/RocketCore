...
{	
	...
	children: [
		...
		},
		{
			type : 'button',
         id : 'browseInternal',
         label : c.browsePages,    // See Note 2
         filebrowser :
			{
				action : 'Browse',
				url : '../../../pageBrowser',    // See Note 3
...
]},{type:"vbox",id:"anchorOptions",width:260,align:"center",padding:0,children:[{type:"fieldset",id:"selectAnchorText",label:b.selectAnchor,setup:function(){d=l.getEditorAnchors(g);this.getElement()[d&&d.length?"show":"hide"]()},children:[{type:"hbox",id:"selectAnchor",children:[{type:"select",id:"anchorName","default":"",label:b.anchorName,style:"width: 100%;",items:[[""]],setup:function(a){this.clear();this.add("");if(d)for(var b=
