...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Cut,Copy,Paste,PasteText,Replace,Font,BGColor,Slideshow,Image,Find,Undo,Redo,Styles,FontSize,Flash';

	// Let's have it basic on dialogs as well.
	config.extraPlugins='simpleuploads,image,fontawesome,dialogadvtab';
