...
$btn = new button("<i class='fa fa-plus'></i> Nový soubor", "tet", "-", "note", "green");
$btn->addSource($target);
echo $btn->getString();
...
$arr = array(1 => "První položka v selectu", 2 => "Druhá položka - 584", 3=> "Něco dalšího");
$data["stitky"] = "1,3"; //simulace předvybraných štítků
//$input = new input("stitky", getSelectedLabels("tbMaterialStitky", $data["id"]), "Štítky");
$input = new input("stitky", $data, "Štítky");
$input->placeholder("Začněte psát název štítku--- zkuste slovo ''Druhá'' ");
